                                ...
                                $(document).ready(function()
                                {
                                  show_branchlist(); //call function show all product    
                                    ...
                                    function show_branchlist()
                                    {
                                      $.ajax({
                                        type  : "POST",
                                        url:"<?php echo base_url('Dashbord/getlist');?>",
                                        dataType : 'json',
                                        responsive:true,
...
html += '<tr>'+
        ...
        '<td>'+data[i].branch_add+ ',<br>' +data[i].state+ ',<br>' +data[i].city_name+ ',<br>' +data[i].pincode+'</td>'+
    ...
    '<a class=" modal-trigger btn btn-danger btn-sm item_delete" data-target="#modal1" ><i class="material-icons">delete_forever</i></a>'+
        '</td>'+
        '</tr>';
                                            }                                           
