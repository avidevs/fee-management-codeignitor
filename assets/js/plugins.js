...
function resizetable() {
   ...
   //       $('.vertical-layout.vertical-gradient-menu .sidenav-dark .brand-logo img').attr('src','<?php echo base_url();?>images/logo/materialize-logo-color.png');
   //    }
   //    if($('.vertical-layout.vertical-dark-menu .sidenav-dark .brand-logo').length > 0){
   //       $('.vertical-layout.vertical-dark-menu .sidenav-dark .brand-logo img').attr('src','<?php echo base_url();?>images/logo/materialize-logo-color.png');
   //    }
   ...
   //    }
   //    if($('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo').length > 0){
   //       $('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo img').attr('src','<?php echo base_url();?>images/logo/materialize-logo-color.png');
   //    }
   //}
}
resizetable();
